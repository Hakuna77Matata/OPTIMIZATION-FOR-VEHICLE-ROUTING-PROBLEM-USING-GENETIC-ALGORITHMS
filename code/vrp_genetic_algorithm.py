...
# Plotting Function
def plot_routes(individual, title="Routes", save=False):
    plt.figure()
    ...
    if save:
        ...
        # Save the plot to the results/plots/ folder with the title as the filename
        plt.savefig(f'results/plots/{title}.png')
...
def main():
    ...
    plot_routes(hof[0], "Optimal Route", save=True)
